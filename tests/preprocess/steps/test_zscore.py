...
def test_zscore_no_baseline_zscore_outliers_signals():
    session = Session()
    # add a 1D signal
    session.add_signal(Signal("signal1", np.sin(np.arange(1000)), fs=1))
    # add a 2D signal
    ...
    step = Zscore(["signal1", "signal2"], mode="zscore", baseline=None, outlier_removal="zscore", outlier_threshold=2)
    step(session)
...
def test_zscore_no_baseline_madscore_outliers_signals():
    session = Session()
    # add a 1D signal
    session.add_signal(Signal("signal1", np.sin(np.arange(1000)), fs=1))
    # add a 2D signal
    ...
    step = Zscore(["signal1", "signal2"], mode="zscore", baseline=None, outlier_removal="madscore", outlier_threshold=2)
    step(session)
...
def test_zscore_no_baseline_modzscore_outliers_signals():
    session = Session()
    # add a 1D signal
    session.add_signal(Signal("signal1", np.sin(np.arange(1000)), fs=1))
    # add a 2D signal
    ...
    step = Zscore(["signal1", "signal2"], mode="zscore", baseline=None, outlier_removal="modified_zscore", outlier_threshold=2)
    step(session)
...
def test_madscore_with_baseline_signals():
    session = Session()
    # add a 1D signal
    session.add_signal(Signal("signal1", np.sin(np.arange(1000)), fs=1))
    # add a 2D signal
    ...
    step = Zscore(["signal1", "signal2"], mode="madscore", baseline=(1, 3))
    step(session)
